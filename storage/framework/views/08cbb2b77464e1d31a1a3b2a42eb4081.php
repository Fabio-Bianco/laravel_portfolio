        ...
        <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-light btn-sm text-dark fw-semibold">Accedi</a>
                </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="card-footer bg-light-subtle text-center">
                    <span class="text-muted small">
                        Hai già un account? <a href="<?php echo e(route('login')); ?>" class="link-secondary">Accedi</a>
                    </span>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Utente\Desktop\my_project\laravel_portfolio\resources\views\auth\register.blade.php ENDPATH**/ ?>