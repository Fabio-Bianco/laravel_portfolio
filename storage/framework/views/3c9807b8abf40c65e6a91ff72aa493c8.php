  ...
  <div class="skills-container">
    ...
    <div class="skills-content">
      <div class="skills-grid">
        ...
        <?php if($technologiesByCategory['frontend']->count()): ?>
          <div class="skill-category-section">
            ...
            <div class="tech-tags">
              <?php $__currentLoopData = $technologiesByCategory['frontend']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tech): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('projects.by-technology-slug', $tech->slug)); ?>" class="tech-tag frontend-tag" title="Progetti con <?php echo e($tech->name); ?>">
        ...
        <?php if($technologiesByCategory['backend']->count()): ?>
          <div class="skill-category-section">
            <div class="skill-category-header">
              <svg width="24" height="24" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
            ...
            <div class="tech-tags">
              <?php $__currentLoopData = $technologiesByCategory['backend']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tech): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('projects.by-technology-slug', $tech->slug)); ?>" class="tech-tag backend-tag" title="Progetti con <?php echo e($tech->name); ?>">
                  <?php echo e($tech->name); ?>
        ...
        <?php if($technologiesByCategory['dev-tools']->count()): ?>
          <div class="skill-category-section">
            <div class="skill-category-header">
              <svg width="24" height="24" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
            ...
            <div class="tech-tags">
              <?php $__currentLoopData = $technologiesByCategory['dev-tools']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tech): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('projects.by-technology-slug', $tech->slug)); ?>" class="tech-tag devtools-tag" title="Progetti con <?php echo e($tech->name); ?>">
                  <?php echo e($tech->name); ?>
...
<?php /**PATH C:\Users\Utente\Desktop\my_project\laravel_portfolio\resources\views/guest/partials/skills-categorized.blade.php ENDPATH**/ ?>