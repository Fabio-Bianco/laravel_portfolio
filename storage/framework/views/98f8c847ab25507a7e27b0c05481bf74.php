...
<?php $__env->startSection('page-title', 'Il Mio Profilo'); ?>
        ...
        <div class="card-body">
          ...
          <form method="POST" action="<?php echo e(route('admin.profile.update')); ?>">
            ...
            <div class="mb-3">
              ...
              <textarea name="bio" class="form-control" rows="4" placeholder="Parlaci di te..."><?php echo e(auth()->user()->bio ?? ''); ?></textarea>
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <input type="text" name="github_username" class="form-control" value="<?php echo e(auth()->user()->github_username ?? ''); ?>" placeholder="username">
              </div>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                ...
                <input type="text" name="linkedin_username" class="form-control" value="<?php echo e(auth()->user()->linkedin_username ?? ''); ?>" placeholder="username">
              </div>
            </div>
            
            <div class="mb-3">
              <label class="form-label">Email Contatto Pubblico</label>
              <input type="email" name="contact_email" class="form-control" value="<?php echo e(auth()->user()->contact_email ?? auth()->user()->email); ?>" placeholder="email@example.com">
    ...
    <div class="col-lg-4">
      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
          ...
          <hr>
          <p class="small"><?php echo e(auth()->user()->bio ?? 'Nessuna bio impostata...'); ?></p>
        </div>
      </div>
...
<?php echo $__env->make('admin.layouts.admin-sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Utente\Desktop\my_project\laravel_portfolio\resources\views\admin\profile\edit.blade.php ENDPATH**/ ?>