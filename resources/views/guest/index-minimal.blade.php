    ...
    <section class="about-section" id="about" role="region" aria-labelledby="about-heading">
      ...
      <div class="about-content">
        <div class="about-text">
          <p class="about-intro">
            Hi! I'm <strong>{{ auth()->user()->name ?? 'Fabio Bianco' }}</strong>, a passionate Full Stack Developer 
    ...
    <div class="contact-content">
      ...
      <div class="contact-info">
        <div class="contact-info-card">
          ...
          <h3>Email</h3>
          <a href="mailto:{{ auth()->user()->contact_email ?? 'fabio@example.com' }}" class="contact-link">
            {{ auth()->user()->contact_email ?? 'fabio@example.com' }}
          </a>
        </div>
        ...
        <div class="contact-info-card">
          ...
          <h3>GitHub</h3>
          <a href="https://github.com/{{ auth()->user()->github_username ?? 'Fabio-Bianco' }}" 
             target="_blank" 
             rel="noopener noreferrer"
             class="contact-link">
            @{{ auth()->user()->github_username ?? 'Fabio-Bianco' }}
          </a>
        </div>
        ...
        <div class="contact-info-card">
          ...
          <h3>LinkedIn</h3>
          <a href="https://www.linkedin.com/in/{{ auth()->user()->linkedin_username ?? 'fabio-bianco-008a0b118' }}/" 
             target="_blank" 
             rel="noopener noreferrer"
             class="contact-link">
            Connect with me
  ...
  <div class="footer-content">
    <div class="footer-grid">
      ...
      <div class="footer-column">
        <h3 class="footer-brand">{{ auth()->user()->name ?? 'Fabio Bianco' }}</h3>
        ...
        <div class="footer-social">
          ...
          <a href="mailto:{{ auth()->user()->contact_email ?? 'fabio@example.com' }}" 
             class="social-link"
      ...
      <div class="footer-column">
        ...
        <a href="https://github.com/{{ auth()->user()->github_username ?? 'Fabio-Bianco' }}/laravel_portfolio" 
           target="_blank" 
           rel="noopener noreferrer"
           class="footer-cta">
    ...
    <div class="footer-bottom">
      <p class="footer-copyright">
        &copy; {{ date('Y') }} {{ auth()->user()->name ?? 'Fabio Bianco' }}. All rights reserved.
      </p>
      <p class="footer-tech">
