...
<div class="bio-sidebar" id="bioSidebar">
  <div class="bio-sidebar-content">
    ...
    <div class="bio-body">
      <h3>About Me</h3>
      <p>
        {{ auth()->user()->bio ?? 'Sviluppatore appassionato di tecnologie web moderne. Specializzato in Laravel, JavaScript e React. Sempre alla ricerca di nuove sfide e opportunità di crescita.' }}
      </p>
