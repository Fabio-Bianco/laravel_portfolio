    ...
    <div class="container">
        <div class="row g-4 g-xl-5">
            ...
            <div class="col-12 col-lg-4">
                <h5 class="text-primary">{{ config('app.owner_name') }}</h5>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-6">
                        ...
                        <ul class="list-unstyled footer-nav">
                            <li>
                                <a href="{{ route('home') }}" class="footer-link" title="Visualizza tutti i progetti del portfolio">
        ...
        <div class="copyright-bar">
            <div class="row">
                <div class="col-md-6">
                    <p class="mb-0 copyright-text">&copy; {{ date('Y') }} {{ config('app.owner_name') }}. Tutti i diritti riservati.</p>
                </div>
